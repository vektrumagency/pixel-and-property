...
export function DigitalPricing() {
  const t = useTranslations("digital.pricing");
  const tiers = t.raw("tiers") as Tier[];

  return (
    <section id="pricing" className="bg-white px-6 pt-16 pb-0 lg:px-24 lg:pt-32">
      <Reveal>
      ...
      <div className="grid gap-4 lg:grid-cols-4 lg:gap-0.5">
        {tiers.map((tier, i) => (
          <Reveal
            key={tier.name}
            delay={i * 100}
